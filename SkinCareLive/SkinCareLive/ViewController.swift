...
//  SkinCareLive
//
//  Created by GongsiWang on 2022/4/11.
//
...
class ViewController: UIViewController {
    ...
    // 创建一个相机
    fileprivate lazy var camera = GPUImageVideoCamera(sessionPreset: AVCaptureSession.Preset.high.rawValue, cameraPosition: .front)
